...
echo -e "<item id=\"cover_image\" href=\"cover.jpg\" media-type=\"image/jpeg\"\n   properties=\"cover-image\"/>" >> ./content.opf
echo -e "<item id=\"nav\" href=\"nav.xhtml\" media-type=\"application/xhtml+xml\"\n   properties=\"nav\"/>\n</manifest>\n<spine>" >> ./content.opf
